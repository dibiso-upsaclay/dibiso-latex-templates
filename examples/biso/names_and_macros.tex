...
\newcommand{\datafetchdate}{02/10/2025}
\newcommand{\watermarktext}{DUMMY DATA}

\newcommand{\worksbibtexinfo}{Le nombre de travaux affichés a été limité à 100. Dans l'API, 16858 entités ont été trouvées.\\}
...
\newcommand{\conferencesinfo}{Le nombre de conférences affichées a été limité à 40. Dans l'API, 2605 conférences ont été trouvées.\\}
...
\newcommand{\journalshalinfo}{Le nombre de revues affichées a été limité à 40. Dans l'API, 3407 revues ont été trouvées.\\}
