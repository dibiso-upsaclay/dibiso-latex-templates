...
%\begin{textblock*}{\textwidth}(0pt, 0pt) % Position at the top of the page
%    \begin{tikzpicture}
%        \node[fill=myyellow, draw=none, rounded corners=5pt, inner sep=2pt] at  ([xshift=\oddsidemargin, yshift=-1in]current page.north west) {
%            \textcolor{myblue}{\textbf{Version [bêta]}}
%        };
%    \end{tikzpicture}
%\end{textblock*}

%\begin{tikzpicture}[remember picture, overlay]
%    \node[fill=myyellow, draw=none, rounded corners=5pt, inner sep=2pt, anchor=north west] at (current page text area.north west) {
%        \textcolor{myblue}{\textbf{Version [bêta]}}
%    };
%\end{tikzpicture}
